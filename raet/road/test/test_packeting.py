...
class MockStack(object):
    '''
    Mock stack with attributes to enable Packet testing
    '''
    def __init__(self, store=None, veritive=True):
        '''
        Create attributes
        '''
        self.store = store
        self.veritive = True if veritive else False
...
class BasicTestCase(unittest.TestCase):
    ...
    def testBasicJson(self):
        ...
        body = odict([('msg', 'Hello Raet World'), ('extra', 'Goodby Big Moon')])
        packet0 = packeting.TxPacket(stack=stack, embody=body, data=data, )
    ...
    def testSegmentation(self):
        ...
        packet0 = packeting.TxPacket(stack=stack, embody=stuff, data=data, )
